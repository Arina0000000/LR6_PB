...
Пронумерованные списки были созданы при помощи чисел, за которыми следует точка, а маркированые списки были созданы при помощи символов `*, - или +`.

```
1. Нумерованный текст.
2. Нумерованный текст.
    - Маркированный текст.
    * Маркированный текст.
    + Маркированный текст.
```
...
```
[Текст, который будет являться ссылкой](https://github.com/...)
```
...
```
<p align="center"><img src="https://github.com/.../image.png"></p>
<p align="center">Текст, который надо выравнять по центру</p></br>
```
...
```
> [!Note]
> Полезная информация, которую можно заметить при беглом просмотре содержимого.
```
