...
Также в данной работе была создана ссылка на изображение при помощи использования квадратных и круглых скобок. Изображения добавляются аналогично ссылкам с одним отличием: добавляется восклицательный знак перед квадратными скобками. 
...
Для создания цитаты используется символ `>`, а для выделения кода используются обратные кавычки (`).
