...
В процессе работы произошла ошибка при попытке удалить ветку: неправильно была введена команда, которая выполнила частичное действие: branch1 была удалена, а master осталась нетронутой. В завершение работы изменения были успешно загружены на GitHub. 
